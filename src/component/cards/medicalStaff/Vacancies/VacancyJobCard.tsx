...
// interface Tag { label: string; color: string; bg: string; }
...
// export default function VacancyJobCard({ job, onApply }: Props) {
...
//         <InfoItem icon="receipt-outline"  text={job.salary}   />
//         <InfoItem icon="time-outline"     text={job.hours}    />
//         <InfoItem icon="location-outline" text={job.distance} />
//       </View>
...
//     borderRadius: 10,
//   },
//   savedBtn:  { borderColor: COLORS.primary, backgroundColor: "#EEF2FF" },
//   saveText:  { fontSize: 14, color: COLORS.subText, fontWeight: "500" },
