...
//                                     <Text style={s.childLabel}>Aadhaar Card ( XX5602 )</Text>
//                                     {aadhaar ? (
//                                         <TouchableOpacity onPress={() => setAadhaar(false)} activeOpacity={0.7}>
//                                             <Ionicons name="checkmark-circle" size={20} color={GREEN} />
//                                         </TouchableOpacity>
//                                     ) : (
//                                         <CheckBox checked={false} onPress={() => setAadhaar(true)} />
//                                     )}
//                                 </View>
//                                 <View style={s.childRow}>
//                                     <Text style={s.childLabel}>PAN Verification Record ( XXK6403J )</Text>
//                                     <CheckBox checked={pan} onPress={() => setPan((v) => !v)} />
//                                 </View>
//                             </View>
//                         )}
...
//                         {/* DigiLocker Drive */}
//                         <View style={s.row}>
//                             <Ionicons name="server-outline" size={18} color={INK} style={s.rowIcon} />
...
//                         <View style={s.row}>
//                             <Ionicons name="calendar-outline" size={18} color={INK} style={s.rowIcon} />
//                             <View style={s.flex1}>
...
//                         >
//                             <Ionicons name="clipboard-outline" size={18} color={INK} style={s.rowIcon} />
//                             <View style={s.flex1}>
...
//     /* ── Consent card (Figma 818 × 768, radius 15) ── */
//     card: {
//         backgroundColor: "#FFFFFF",
//         borderRadius: 15,
