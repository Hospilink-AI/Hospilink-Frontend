      ...
      <View style={styles.pageContainer}>
        ...
        <View style={styles.listArea}>
          {loading ? (
            ...
            /* ── DESKTOP TABLE (pinned head, scrolling rows) ── */
            <View style={[styles.tableCard, styles.tableCardFill]}>
              ...
              <ScrollView
                ...
                contentContainerStyle={styles.tableRowsContent}
                showsVerticalScrollIndicator
              >
                {duties.map((d, i) => (
                  <TableRow
...
const styles = StyleSheet.create({
  ...
  // Fixed-height page wrapper: header/filter/pagination pinned, list scrolls.
  pageContainer: { flex: 1, padding: 16, minHeight: 0 },

  // List area fills remaining vertical space between filter bar and pagination.
