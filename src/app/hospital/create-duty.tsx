...
export default function CreateDutyScreen() {
  ...
  // Update field and clear its specific error instantly
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Show backend errors on the UI instead of Alert
...
const styles = StyleSheet.create({
  ...
  publishBtn: { paddingHorizontal: 20, paddingVertical: 10, borderRadius: 8, backgroundColor: '#2563EB', minWidth: 120, alignItems: 'center' },
  ...
  infoBox: { flexDirection: 'row', gap: 12, backgroundColor: '#2563EB', borderRadius: 8, padding: 16, alignItems: 'center' },
