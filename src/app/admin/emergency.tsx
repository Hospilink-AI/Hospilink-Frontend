        ...
        <View style={styles.twoColRow}>
          ...
          <View style={styles.colLeft}>
            ...
            <View style={styles.card}>
              <SectionHeader icon="list-outline" label="Duty Specifications" color="#DC2626" />
...
<FieldError message={errors.hospitalId} />
              ...
              <View style={styles.row2}>
                ...
                <View style={styles.col}>
                  ...
                  <View style={[styles.dropdown, { backgroundColor: '#FEF2F2', borderColor: '#FECACA' }]}>
                    <Text style={[styles.dropdownText, { color: '#DC2626', fontWeight: '700' }]}>
                      Emergency
                    </Text>
  ...
  <View style={{ marginBottom: 14 }}>
    ...
    <View style={{ flexDirection: 'row', gap: 8, flexWrap: 'wrap' }}>
      {RMO_SUB_TYPES.map(opt => {
        ...
        return (
          ...
          >
            <Text style={{ fontSize: 13, fontWeight: '600', color: active ? '#DC2626' : '#6B7280' }}>
              {opt.label}
            </Text>
          </TouchableOpacity>
        );
    ...
    <FieldError message={errors.dutySubType} />
            ...
            <View style={styles.card}>
              <SectionHeader icon="document-text-outline" label="Terms & Description" color="#DC2626" />
          ...
          <View style={styles.colRight}>
            <View style={styles.card}>
              <SectionHeader icon="calendar-outline" label="Schedule Details" color="#DC2626" />
              ...
              <View style={styles.overtimeBox}>
                ...
                <Switch
                  ...
                  thumbColor={form.overtimeDuty ? '#DC2626' : '#fff'}
                />
              </View>
...
const styles = StyleSheet.create({
  ...
  dropdownFocused: { borderColor: '#DC2626' },
  ...
  infoText: { flex: 1, fontSize: 12, color: '#DC2626', lineHeight: 18 },
