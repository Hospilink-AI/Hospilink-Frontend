...
function parseBackendErrors(err: any): { fieldErrors: FormErrors; generalError: string } {
  ...
  // { errors: { staff_role: "msg", offered_rate: "msg" } }
  ...
  // { field: "hospital_id", message: "Hospital not found" }
                ...
                return (
                  ...
                  >
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 2 }}>
                      ...
                      <View style={{ backgroundColor: badge.bg, paddingHorizontal: 5, paddingVertical: 2, borderRadius: 4 }}>
                        <Text style={{ fontSize: 8, fontWeight: '600', color: badge.text, letterSpacing: 0.3 }}>
                    ...
                    <Text style={{ fontSize: 11, color: '#9CA3AF', lineHeight: 14 }} numberOfLines={1}>
                      {item.location}
                    </Text>
                  </TouchableOpacity>
                );
...
export default function CreateDutyScreen() {
  ...
  // Add these alongside your existing useState calls
  const [errors, setErrors] = useState<FormErrors>({});
  const [generalError, setGeneralError] = useState('');

  // Replace existing set helper
