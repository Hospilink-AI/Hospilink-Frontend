...
// type FormState = {
//   hospitalId: string;
//   hospitalName: string; // Stored just for display purposes
//   staffRole: string;
//   urgencyLevel: string;
//   startingDate: string;
//   endingDate: string;
...
//           {/* New Hospital Dropdown Row */}
//           <View style={[styles.row2, { marginBottom: 16 }]}>
//             <View style={styles.col}>
//               <FieldLabel label="Select Hospital" required />
...
//   searchInputWrap: { flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#E5E7EB', paddingHorizontal: 12, paddingVertical: 10 },
//   searchDropdownInput: { flex: 1, marginLeft: 8, fontSize: 13, color: '#111827', outlineWidth: 0, paddingVertical: Platform.OS === 'ios' ? 4 : 0 },
